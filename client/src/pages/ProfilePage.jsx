...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flext items-center justify'>
      <div className='w-5/6 max-w-2x1 backdrop-blur-2x1 text-gray-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounde-lg'>

        <form onSubmit={handleSubmit} className='flex flex-col gap p-10 flex-1'>
        ...
        <label htmlFor='avatar' className='flex items-center gap-3 cursor-pointer'>
          ...
          <input onChange={(e) =>setName(e.target.value)} value={name} type='text' required placeholder='Your Name' className='p-2 border border-gray-500-md:outline-none focus:ring-2 focus:ring-violet-500'/>
