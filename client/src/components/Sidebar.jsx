       ...
       <div className='pb-5'>
        <div className='flex justify-between items-center'>
            ...
            <div className='relative py-2 group'>
                <img src={assets.menu_logo} alt='menu' className='max-h-5 cursor-pointer'/>
                ...
                key = {index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                    ...
                    <div className='flex flex-col leading-5'>
                        <p>{user.fullName}</p>
                        {
                            ...
                            ? <spam className='text-green-400 text-xs'>Online</spam>
                            : <spam className='text-neutral-400 text-xs'>Offline</spam>
                        }
